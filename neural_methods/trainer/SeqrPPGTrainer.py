...
from neural_methods.model.Seq_rPPG import Seq_rPPG
...
class TscanTrainer(BaseTrainer):
    ...
    def __init__(self, config, data_loader):
        ...
        if config.TOOLBOX_MODE == "train_and_test":
            self.model = Seq_rPPG().to(self.device)
            ...
            raise ValueError("Seq_rPPG trainer initialized in incorrect toolbox mode!")
